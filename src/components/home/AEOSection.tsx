...
const aeoSolutionsBg = '/assets/a902e3f0e8a16e199e12b5bf0b790194e662556a.webp';

export function AEOSection() {
  const handleLearnMore = () => {
    navigateTo('/offerings/aeo');
  };
        ...
        <div className="mx-auto w-full max-w-[420px] sm:max-w-[640px] md:max-w-[720px] lg:max-w-[1200px]">
          ...
          <div className="grid lg:grid-cols-2 gap-5 sm:gap-6 md:gap-8 lg:gap-12 items-center">
            ...
            <div 
              ...
              aria-label="Learn more about AEO - Answer Engine Optimization"
              style={{
            ...
            >
              <img
                src={aeoSolutionsBg}
                alt="green abstract grid or connected data web"
